...
<br><br>
<a class="btn-emp-2" href="descarga.php?file=modelo_creacion_proveedores.csv">Descargar modelo creación proveedores</a>
	<br><br>
	<form id="importacion" action="importar.php" enctype="multipart/form-data" method="POST">
		<input type="file" name="file" accept=".csv">
		<br><br>
		<input type="hidden" name="action" value="crearProveedores">
		<input type="submit" name="import" value="Subir fichero">
	</form>
<br>
	<form action="accionesProveedores.php" method="post">
			<input type="hidden" name="action" value="crear">
			<input class="btn-emp-2" type="submit" value="Crear Proveedor">
	</form>
